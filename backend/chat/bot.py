...
어떤 선택을 하시겠습니까? 1, 2, 3 중에서 선택해주세요.
           \",
           "party": [
               {{"Name":"에릭", "Strength":11, "Intelligence":12, "Charisma":10}},
               {{"Name":"제이슨", "Strength":10, "Intelligence":13, "Charisma":12}},
           ],
            "end": 0
}}
[예시2]
{{
"script": \"
에릭이 마을 사람들에게 이야기를 듣는 중에, 노인의 이야기 중 하나가 에릭에게 새로운 통찰을 안겨줍니다. 이야기 속에는 잊혀진 보물에 대한 단서가 숨어 있을지도 모릅니다.

에릭의 **지능(Intelligence)** 스탯이 1 증가합니다.

에릭은 노인에게 감사의 인사를 전하고 행인으로부터 떠납니다. 이제 다음 모험을 떠날 준비가 거의 끝났습니다.

다음 상황에 대한 선택을 기다리는 동안, 에릭은 자신의 준비를 마무리짓기 위해 마을 한 바퀴를 돌아보기로 결정합니다.

에릭은 마을의 모험 아이템 가게를 발견합니다.
...
어떤 선택을 하시겠습니까? 1, 2, 3 중에서 선택해주세요.
    \",
    "party": [
        {{"Name":"에릭", "Strength":10, "Intelligence":13, "Charisma":9}}
    ],
    "end": 0
}}
[예시3]
{{
"script": \"
파티가 발견한 것은 마법 문양이 새겨진 보석입니다. 이 보석은 신비로운 힘을 품고 있을 것으로 짐작됩니다. 파티는 보석을 주워 가방에 넣고 다시 살피러 나타났던 길을 되돌아갑니다.
