...
def system_sub_instructions(member_count):
    ...
    [예시1]
{"script": "[세계 설정] 파티는 모험가로 이루어진 그룹으로, 위험한 지역을 탐험하고 보물을 찾는 모험을 떠나게 됩니다.\n[파티 멤버]\n- 이름: 에릭\n- 이름: 제이슨\n[ 파티원 스탯 [\n[에릭]\n- 힘(str): 11\n- 지능(int): 12\n- 카리스마(cha): 10\n[제이슨]\n- 힘(str): 14\n- 지능(int): 12\n- 카리스마(cha): 12\n파티원은 여정을 시작하기 전, 마을 광장에서 어떤 일을 할지 선택해야 합니다.\n[어떤 일을 하시겠습니까?]\n1. 시장에서 장비를 구매한다. \n2. 마을 사람들에게 이야기를 듣는다.\n3. 훈련소에서 실력을 갈고 닦는다.\n어떤 선택을 하시겠습니까? 1, 2, 3 중에서 선택해주세요.",
           "party": [
               {"name":"에릭", "str":11, "int":12, "cha":10},
               {"name":"제이슨", "str":10, "int":13, "cha":12}
           ],
           
            "end": 0
}
[예시2]
{"script": "에릭이 마을 사람들에게 이야기를 듣는 중에, 노인의 이야기 중 하나가 에릭에게 새로운 통찰을 안겨줍니다. 이야기 속에는 잊혀진 보물에 대한 단서가 숨어 있을지도 모릅니다.\n에릭의 [지능(int)] 스탯이 1 증가합니다.\n에릭은 노인에게 감사의 인사를 전하고 행인으로부터 떠납니다. 이제 다음 모험을 떠날 준비가 거의 끝났습니다.\n다음 상황에 대한 선택을 기다리는 동안, 에릭은 자신의 준비를 마무리짓기 위해 마을 한 바퀴를 돌아보기로 결정합니다.\n에릭은 마을의 모험 아이템 가게를 발견합니다.\n[어떤 아이템을 구매하시겠습니까?]\n1. 강력한 검\n2. 신비한 지팡이\n3. 방어용 갑옷\n어떤 선택을 하시겠습니까? 1, 2, 3 중에서 선택해주세요.",
    "party": [
        {"name":"에릭", "str":10, "int":13, "cha":9},
        {"name":"제이슨", "str":12, "int":10, "cha":9}
    ],
    "end": 0
}
